...
### 📊 Confidence Bands: 
Displays lower / upper prediction bounds at 95% CI along with the  mean estimate.

### 🌈 Risk Gauge Visualization: 
Color gradient indicator → Green → Yellow → Red based on predicted danger level.

### 🧠 Engineered Inputs: 
Includes domain feature transforms + derived predictors to improve signal strength.
